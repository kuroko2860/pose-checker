...
const i18n = {
  en: {
    ...
    legAngleIncorrect: "Leg angle incorrect for stance type",
    leftLegNotStraight: "Left leg not straight enough",
    rightLegNotStraight: "Right leg not straight enough",
    leftArmNotStraight: "Left arm not straight enough",
    rightArmNotStraight: "Right arm not straight enough",
    gunArmNotStraight: "Gun arm not straight enough",
    leftArmBodyAngleIncorrect: "Left arm-body angle incorrect, {angle} degrees",
    rightArmBodyAngleIncorrect: "Right arm-body angle incorrect, {angle} degrees",
    gunArmBodyAngleIncorrect: "Gun arm-body angle incorrect, {angle} degrees",
    supportArmBodyAngleIncorrect: "Support arm-body angle incorrect, {angle} degrees",
    supportArmWristAngleIncorrect: "Support arm wrist angle incorrect, {angle} degrees",
    ...
    otherLegKneeAngleIncorrect: "Other leg knee angle incorrect (should be 40-50°)",
  ...
  vi: {
    ...
    legAngleIncorrect: "Góc chân không đúng cho loại tư thế",
    leftLegNotStraight: "Chân trái không đủ thẳng",
    rightLegNotStraight: "Chân phải không đủ thẳng",
    leftArmNotStraight: "Tay trái không đủ thẳng",
    rightArmNotStraight: "Tay phải không đủ thẳng",
    gunArmNotStraight: "Tay cầm súng không đủ thẳng",
    leftArmBodyAngleIncorrect: "Góc tay trái-thân người không đúng, {angle} độ",
    rightArmBodyAngleIncorrect: "Góc tay phải-thân người không đúng, {angle} độ",
    gunArmBodyAngleIncorrect: "Góc tay cầm súng-thân người không đúng, {angle} độ",
    supportArmBodyAngleIncorrect: "Góc tay hỗ trợ-thân người không đúng, {angle} độ",
    supportArmWristAngleIncorrect: "Góc cổ tay tay hỗ trợ không đúng, {angle} độ",
    ...
    otherLegKneeAngleIncorrect: "Góc đầu gối chân kia không đúng (nên là 40-50°)",
